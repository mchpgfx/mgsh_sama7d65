...
leResult screenShow_Home(void)
{
    ...
    Home_BackgroundPanel->fn->setSize(Home_BackgroundPanel, 720, 1280);
    ...
    Home_ImageWidgetMCHPLogo->fn->setPosition(Home_ImageWidgetMCHPLogo, 257, 16);
    ...
    Home_ImageWidgetMGSLogo->fn->setPosition(Home_ImageWidgetMGSLogo, 240, 1167);
    ...
    Home_ButtonWidgetQuickStart->fn->setPosition(Home_ButtonWidgetQuickStart, 240, 1074);
