...
leLabelWidget* Screen1_FPSLabel;
...
leResult screenShow_Screen1(void)
{
    ...
    Screen1_FPSBackground->fn->setSize(Screen1_FPSBackground, 720, 1280);
    ...
    Screen1_FPSSideContainer->fn->setPosition(Screen1_FPSSideContainer, 570, 150);
    Screen1_FPSSideContainer->fn->setSize(Screen1_FPSSideContainer, 150, 470);
    ...
    Screen1_FPSSideContainer->fn->addChild(Screen1_FPSSideContainer, (leWidget*)Screen1_FPSUpdateValue);
