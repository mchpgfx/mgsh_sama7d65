...
leLabelWidget* Screen3_FPSLabel;
...
leResult screenShow_Screen3(void)
{
    ...
    Screen3_ImageBackground->fn->setSize(Screen3_ImageBackground, 720, 1280);
    ...
    Screen3_ImageTypeNextButton->fn->setPosition(Screen3_ImageTypeNextButton, 80, 345);
    Screen3_ImageTypeNextButton->fn->setSize(Screen3_ImageTypeNextButton, 70, 40);
    ...
    Screen3_ImageTypePrevButton->fn->setPosition(Screen3_ImageTypePrevButton, 1, 345);
    Screen3_ImageTypePrevButton->fn->setSize(Screen3_ImageTypePrevButton, 70, 40);
    ...
    Screen3_ImageTypeValue->fn->setPosition(Screen3_ImageTypeValue, 60, 320);
    ...
    Screen3_ImageTypeLabel->fn->setPosition(Screen3_ImageTypeLabel, 4, 320);
    Screen3_ImageTypeLabel->fn->setSize(Screen3_ImageTypeLabel, 50, 19);
