...
leResult screenShow_Screen0(void)
{
    ...
    Screen0_SplashBackground->fn->setSize(Screen0_SplashBackground, 720, 1280);
    ...
    Screen0_SplashBar->fn->setPosition(Screen0_SplashBar, 720, 1189);
    Screen0_SplashBar->fn->setSize(Screen0_SplashBar, 720, 91);
    ...
    Screen0_SplashBar->fn->setHAlignment(Screen0_SplashBar, LE_HALIGN_LEFT);
    ...
    Screen0_SplashMicrochipLogo->fn->setPosition(Screen0_SplashMicrochipLogo, 280, 1210);
    Screen0_SplashMicrochipLogo->fn->setSize(Screen0_SplashMicrochipLogo, 202, 55);
